...
import com.example.asus.weathernow.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (weatherString != null) {
            //有缓存则直接解析天气数据
            Weather weather = Utilty.handleWeaterResponse(weatherString);
    ...
    private void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="
                + weatherId + "&key=224387fa692e4ce49973a4e4bf8116e0";
        HttpUtils.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final Weather weather = Utilty.handleWeaterResponse(responseText);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
